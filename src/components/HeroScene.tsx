  ...
  return (
    <div className="absolute inset-0 z-0 bg-[#000103] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Celestial Starfield Layer (Slow rotation) */}
        ...
        <div 
          ...
          style={{
            ...
            backgroundImage: `radial-gradient(1.2px 1.2px at 20px 30px, #fff, rgba(0,0,0,0)), 
                              ...
                              radial-gradient(1.2px 1.2px at 50px 160px, #fff, rgba(0,0,0,0)), 
                              radial-gradient(2px 2px at 90px 40px, #e6f0ff, rgba(0,0,0,0)), 
                              radial-gradient(1.1px 1.1px at 130px 80px, #fff, rgba(0,0,0,0)), 
                              radial-gradient(1.2px 1.2px at 160px 120px, #fff, rgba(0,0,0,0)),
                              radial-gradient(1.1px 1.1px at 250px 350px, #fff, rgba(0,0,0,0)),
                              radial-gradient(1.2px 1.2px at 400px 150px, #fff, rgba(0,0,0,0)),
            ...
            filter: `blur(${Math.max(0, (zoomLevel - 1.5) * 0.4)}px)`
          }}
        />
        
        {/* Dense Starfield Layer 2 (Medium parallax) */}
        <div 
          ...
          style={{
            ...
            backgroundImage: `radial-gradient(1px 1px at 15px 25px, #fff, rgba(0,0,0,0)), 
                              ...
                              radial-gradient(1px 1px at 125px 15px, #fff, rgba(0,0,0,0)), 
        ...
        {/* Dense Starfield Layer 3 (Tiny specks) */}
        <div 
        ...
        {/* Subtle Nebulae Layers (Fastest parallax for depth effect) */}
        <div 
        ...
        {/* Shooting Stars - Rarer and more subtle gradient */}
