    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="p-6 md:p-10 border-b border-white/10 flex justify-between items-center bg-eu-panel sticky top-0 z-20">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-eu-gold/20 rounded-xl flex items-center justify-center border border-eu-gold/50">
                  <BookOpen className="text-eu-gold" size={24} />
                </div>
                <div>
                  <span className="text-[10px] uppercase font-bold text-eu-gold tracking-widest block mb-1">Detailliertes Archiv</span>
                  <h2 className="text-2xl md:text-4xl font-display font-black text-white uppercase tracking-tighter">
                    {title}
                  </h2>
                </div>
              </div>
            ...
            {/* Content Body */}
            <div className="flex-1 overflow-y-auto p-6 md:p-16 space-y-16">
              {content.sections.map((section, idx) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-6">
                    <span className="text-eu-gold font-mono text-xl opacity-50">{String(idx + 1).padStart(2, '0')}</span>
                    <h3 className="text-2xl md:text-3xl font-display font-bold text-white uppercase tracking-tight">{section.subtitle}</h3>
                  </div>
